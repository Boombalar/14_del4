...
public class Board {
	...
	/**
	 * Konstruktør til Board()
	 */
	public Board() {
		// - opretter felter
		//field[<nr. i arrayet>] = new (<underklassen som feltet hører til>, <navn>, <data fra underklassens opbygning af arrayet>)
...
//	}
	...
	//Bræt hvor spiller 1 ejer det hele, og der er mindst 1 huse på alle propertyfelter.
			field[0] = new StartField("Start",5,0);
	...
	// Blandet mellem 6 spillere
//	  field[0] = new StartField("Start",5,0);
//	  field[1] = new PropertyFields("Rødovrevej",0,1,1200,1,1,50,250,750,2250,4000,6000,5,1000);
//	  field[2] = new ChanceField("?",4,2);
//	  field[3] = new PropertyFields("Hvidovrevej",0,3,1200,1,1,50,250,750,2250,4000,6000,5,1000);
//	  field[4] = new TaxField("Betal indkomst Skat",3,4,4000);
//	  field[5] = new ShippingFields("SFL",1,5,4000,1,9,500,1000,2000,4000);
//	  field[6] = new PropertyFields("Roskildevej",0,6,2000,2,2,100,600,1800,5400,8000,11000,2,1000);
//	  field[7] = new ChanceField("?",4,7);
//	  field[8] = new PropertyFields("Valby Langgade",0,8,2000,2,2,100,600,1800,5400,8000,11000,2,1000);
//	  field[9] = new PropertyFields("Allégade",0,9,2400,2,2,100,600,1800,5400,8000,11000,2,1000);
//	  field[10] = new NoActionField("Statsfængslet",6,10);
//	  field[11] = new PropertyFields("Frederiksberg Allè",0,11,2800,3,3,200,1000,3000,9000,12500,15000,2,2000);
//	  field[12] = new BreweryFields("Tuborg",2,12,3000, 2, 10,100,200);
//	  field[13] = new PropertyFields("Bülowsvej",0,13,2800,3,3,200,1000,3000,9000,12500,15000,2,2000);
//	  field[14] = new PropertyFields("Gl.Kongevej", 0,14,3200,3,3,250,1250,3750,10000,14000,18000,2,2000);
//	  field[15] = new ShippingFields("Kalu & Årh",1,15,4000,3,9,500,1000,2000,4000);
//	  field[16] = new PropertyFields("Bernstorffsvej",0,16,3600,4,4,300,1400,4000,11000,15000,19000,2,2000);
//	  field[17] = new ChanceField("?",4,17);
//	  field[18] = new PropertyFields("Hellerupvej",0,18,3600,4,4,300,1400,4000,11000,15000,19000,2,2000);
//	  field[19] = new PropertyFields("Strandvej",0,19,4000,4,4,350,1600,4400,12000,16000,20000,2,2000);
//	  field[20] = new NoActionField("Parkering", 6,20);
//	  field[21] = new PropertyFields("Trianglen",0,21,4400,5,5,350,1800,5000,14000,17500,21000,2,3000);
//	  field[22] = new ChanceField("?",4,22);
//	  field[23] = new PropertyFields("Østerbrogade",0,23,4400,5,5,350,1800,5000,14000,17500,21000,2,3000);
//	  field[24] = new PropertyFields("Grønningen",0,24,4800,5,5,400,2000,6000,15000,18500,22000,2,3000);
//	  field[25] = new ShippingFields("DFDS",1,25,4000,5,9,500,1000,2000,4000);
//	  field[26] = new PropertyFields("Bredgade",0,26,5200,6,6,450,2200,6600,16000,19500,23000,2,3000);
//	  field[27] = new PropertyFields("Kgs.Nytorv",0,27,5200,6,6,450,2200,6600,16000,19500,23000,2,3000);
//	  field[28] = new BreweryFields("Coca-Cola",2,28,3000,6, 10,100,200);
//	  field[29] = new PropertyFields("Østergade",0,29,5600,6,6,500,2400,7200,17000,20500,24000,2,3000);
//	  field[30] = new GoToJailField("De fængsles",7,30,11);
//	  field[31] = new PropertyFields("Amagertorv",0,31,6000,1,7,550,2600,7800,18000,22000,25000,2,4000);
//	  field[32] = new PropertyFields("Vimmelskaftet",0,32,6000,1,7,550,2600,7800,18000,22000,25000,2,4000);
//	  field[33] = new ChanceField("?",4,33);
//	  field[34] = new PropertyFields("Nygade",0,34,6400,1,7,600,3000,9000,20000,24000,28000,2,4000);
//	  field[35] = new ShippingFields("Hals & Knud",1,35,4000,3,9,500,1000,2000,4000);
//	  field[36] = new ChanceField("?",4,36);
//	  field[37] = new PropertyFields("Frederiksberggade",0,37,7000,2,8,700,3500,10000,22000,26000,30000,2,4000);
//	  field[38] = new TaxField("Betal skat",3,38,2000);
//	  field[39] = new PropertyFields("Rådhuspladsen",0,39,8000,2,8,1000,4000,12000,28000,34000,40000,2,4000);
//	}
